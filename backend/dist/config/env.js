...
const envSchema = z.object({
    ...
    AUDIT_CONFIG_PATH: z.string().min(1).optional(),
...
if (parsed.success) {
    ...
    resolvedEnv = {
        ...
        AUDIT_CONFIG_PATH: fallback.data.AUDIT_CONFIG_PATH,
        EMBEDDING_PROVIDER: fallback.data.EMBEDDING_PROVIDER,
        OPENAI_API_KEY: fallback.data.OPENAI_API_KEY,
        OPENAI_EMBEDDING_MODEL: fallback.data.OPENAI_EMBEDDING_MODEL,
