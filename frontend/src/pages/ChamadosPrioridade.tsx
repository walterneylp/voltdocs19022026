...
export function ChamadosPrioridade() {
            ...
            <div className="chamados-field">
              ...
              <div className="chamados-select">
                ...
                <div className="chamados-select-dropdown">
                  <div className="chamados-select-option">BAIXA</div>
                  <div className="chamados-select-option is-active">MÉDIA</div>
                  <div className="chamados-select-option">ALTA</div>
                  <div className="chamados-select-option">CRÍTICA</div>
                </div>
              </div>
            </div>
          </div>
