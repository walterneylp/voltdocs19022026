...
import { createAsset, getMe, listSites } from "../lib/api";
import "../styles/equipamentos.css";
import "../styles/equipamentos-novo.css";

export function EquipamentosNovo() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Falha ao criar equipamento.");
    } finally {
      setIsSaving(false);
    }
  };
  ...
  return (
    <div className="equip-novo">
      ...
      <section className="equip-modal" role="dialog" aria-label="Novo Equipamento">
